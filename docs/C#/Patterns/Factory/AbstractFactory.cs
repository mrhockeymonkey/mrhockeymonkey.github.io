...
{
  /// <summary>
  /// Abstract factory pattern defines a pattern of returning only abstract/interfaces 
  /// the concrete classes allow you to alter the implementation without breaking client code
  /// this approach is good when there are multiple types of products that can be selected from
  /// </summary>
  ...
  public class HotDrinkMachine
  {
    ...
    public HotDrinkMachine()
    {
      ...
      // to be extendable/plugin based use reflection to find all claases that implement IHotDrinkFactory
