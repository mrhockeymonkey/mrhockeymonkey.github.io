...
namespace DesignPatterns.AdapterPatterns
{
  ...
  /// When using generic you are only able to pass around types.
  /// If you want to use a value you can make an adapter from value to type
  /// </summary>
  ...
  // the below is an example of usage using the builder and recursive generics pattern
    ...
    where TSelf : Vector<TSelf, T, D>, new()
  {
    ...
    public Vector()
    {
      data = new T[new D().Value]; // here we use the value passed in as a type
    }
